...
mn_8 = generiranje_beta( 0.5, 0.1, 8, 1 , 0.01, 0.25, 100)
mn_12 = generiranje_beta( 0.5, 0.1, 12, 1 , 0.01, 0.25, 100)
mn_16 = generiranje_beta( 0.5, 0.1, 16, 1 , 0.01, 0.25, 100)
mn_20 = generiranje_beta( 0.5, 0.1, 20, 1 , 0.01, 0.25, 100)
mn_24 = generiranje_beta( 0.5, 0.1, 24, 1 , 0.01, 0.25, 100)
mn_28 = generiranje_beta( 0.5, 0.1, 28, 1 , 0.01, 0.25, 100)
mn_32 = generiranje_beta( 0.5, 0.1, 32, 1 , 0.01, 0.25, 100)
mn_36 = generiranje_beta( 0.5, 0.1, 36, 1 , 0.01, 0.25, 100)
mn_40 = generiranje_beta( 0.5, 0.1, 40, 1 , 0.01, 0.25, 100)
mn_44 = generiranje_beta( 0.5, 0.1, 44, 1 , 0.01, 0.25, 100)
mn_48 = generiranje_beta( 0.5, 0.1, 48, 1 , 0.01, 0.25, 100)
